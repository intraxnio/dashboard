...
ROOTCARES ESSENTIALS PRIVATE LIMITED does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.
...
In case of any Refunds approved by the ROOTCARES ESSENTIALS PRIVATE LIMITED, it’ll take 3-5 days for the refund to be processed to the end customer.
        </p>
    </div>
    <Footer />
   </>
