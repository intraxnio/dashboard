...
useEffect(() => {
    ...
    axios.post("http://localhost:8000/api/v1/creator/interested/campaigns", {
 ...
 {user.isLoggedIn ? (!loading ? (
    ...
    {campaignData.map((item) =>  ( <Grid item xs={6} sm={6} md={6} container
      ...
      <Card xs={6} sm={6} md={3} sx={{ maxWidth: 500 }}>
           ...
           <Tooltip
    title="You have already showed Interest to the campaign. The Brand will Approve your request soon."
    placement='top'
  >
