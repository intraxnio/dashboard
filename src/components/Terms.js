...
Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern ROOTCARES ESSENTIALS PRIVATE LIMITED`s relationship with you in relation to this website.

The term `ROOTCARES ESSENTIALS PRIVATE LIMITED` or `us` or `we` refers to the owner of the website whose registered/operational office is Plot no - 210, Century Hills, Bhagyanagar Colony, Allapur, Hyderabad Hyderabad TELANGANA 500018. The term `you` refers to the user or viewer of our website.
...
You may not create a link to this website from another website or document without ROOTCARES ESSENTIALS PRIVATE LIMITED`s prior written consent.
